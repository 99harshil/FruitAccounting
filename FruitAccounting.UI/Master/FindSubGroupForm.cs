...
{
    public partial class FindSubGroupForm : BaseSearchForm<AccountGroup>
    {
        private readonly AccountGroupService _accountGroupService;
        private readonly long _companyId;

        public FindSubGroupForm(AccountGroupService accountGroupService, long companyId)
        {
            InitializeComponent();
        ...
        protected override async Task LoadAllDataAsync()
        {
            try
            {
                _allData = await _accountGroupService.GetAllSubGroupsAsync(_companyId);
        ...
        protected override void DisplayData(List<AccountGroup> data)
        {
            ...
            {
                dgvGroups.Rows.Add(group.Name, group.Parent?.Name, group.AccountGroupId);
            }
