...
{
    partial class FindItemCategoryForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvGroups.Columns.AddRange(new DataGridViewColumn[] { colDescription, colGroupId });
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "FindItemCategoryForm";
            StartPosition = FormStartPosition.CenterParent;
            Text = "Item Category List";
            Load += FindItemCategoryForm_Load;
